...
export default function SertificationsCard({
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-neutral-200 bg-linear-to-br from-white via-white to-neutral-50 shadow-sm transition-all duration-300 hover:shadow-lg">
      <div className="grid grid-cols-1 sm:grid-cols-[170px_minmax(0,1fr)]">
        <div className="relative min-h-44 overflow-hidden bg-neutral-100">
          <div className="absolute inset-0 bg-linear-to-br from-neutral-900/0 via-neutral-900/0 to-neutral-900/10" />
          <img
            src={imageUrl}
            alt={title}
