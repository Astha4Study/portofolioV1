  ...
  const Achivements = [
    {
      ...
      year: "2026",
      description: "Awarded 3rd Place in an international web development competition for delivering an innovative, user-focused solution with strong technical execution and modern development practices.",
    ...
    },
    {
      ...
      year: "2025",
      description: "Awarded for ranking in the Top 10 of an international web development competition, showcasing strong problem-solving and modern web engineering skills.",
      websiteUrl: "https://proxo-2026.vercel.app/",
    },
    {
      ...
      year: "2025",
      description: "Secured 2nd place in a national web development competition, demonstrating excellence in building scalable and user-focused applications.",
    ...
    },
    {
      ...
      year: "2025",
      description: "Achieved 2nd place in a national software engineering competition, highlighting strong system design and development capabilities.",
    ...
    },
    {
      ...
      year: "2025",
      description: "Ranked 3rd in a national IoT competition, demonstrating the ability to integrate hardware and software into practical solutions.",
    ...
    },
    {
      ...
      year: "2024",
      description: "Won 1st place in a university innovation competition, delivering a high-impact mobile and web-based solution.",
    ...
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {Achivements.map((achivement, index) => (
          <AchivementsCard key={index} imageUrl={achivement.imageUrl} title={achivement.title} year={achivement.year} description={achivement.description} websiteUrl={achivement.websiteUrl} />
        ))}
      </div>
    </div>
  );
